...
wedges2,texts2,autotexts2 = plt.pie(weight2,autopct="%3.1f%%",radius=0.7,pctdistance=0.7,colors=inner_colors,textprops=dict(color="w"),wedgeprops=dict(width=0.4,edgecolor="w"))
